    ...
    <section id="modals">
      ...
      <div class="row">
        <div class="span3 columns">
          <h3>About modals</h3>
          <p>A streamlined, but flexible, take on the traditional javascript modal plugin with only the minimum required functionality and smart defaults.</p>
          <a href="#" target="_blank" class="btn">Download file</a>
        </div>
          ...
          <div id="myCarousel" class="carousel slide">
            <div class="carousel-inner">
              <div class="item active">
				<?php echo $this->Html->image('bootstrap-mdo-sfmoma-01.jpg', array('alt' => 'CakePHP')); ?>
              ...
              <div class="item">
				<?php echo $this->Html->image('bootstrap-mdo-sfmoma-02.jpg', array('alt' => 'CakePHP')); ?>
                <div class="carousel-caption">
              ...
              <div class="item">
				<?php echo $this->Html->image('bootstrap-mdo-sfmoma-03.jpg', array('alt' => 'CakePHP')); ?>
                <div class="carousel-caption">
